...
(function(root){
  ...
  function fromEnquiry(d){if(!d||typeof d!=='object'||!d.reference)throw Error('This enquiry has no reference.');const options=Array.isArray(d.options)&&d.options.length?d.options:parseRequirement(d.brief);if(options.length>100)throw Error('More than 100 items; import stopped without truncation.');return{...d,mode:'items',options};}
